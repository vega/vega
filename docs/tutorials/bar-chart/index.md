...
We've now worked through a full Vega visualization! Next, we recommend experimenting with and modifying this example. Copy & paste the full specification above into the online **[Vega Editor](http://vega.github.io/new-editor/)** or fork [our Block](https://bl.ocks.org/domoritz/cd636b15fa0e187b51b73fc60b4d3014).
