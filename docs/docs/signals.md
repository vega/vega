...
| init                | [Expression](../expressions)   | {% include tag ver="4.4" %} An initialization expression for the value of the signal. This expression will be invoked once and only once. The _init_ and _update_ parameters are mutually exclusice and can not be used together.|
