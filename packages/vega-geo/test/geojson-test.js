...
tape('GeoJSON transform consolidates lon/lat data', function(test) {
  var data = geodata();
  ...
  test.equal(JSON.stringify(gj.value),
...
tape('GeoJSON transform consolidates geojson data', function(test) {
  var data = geodata();
...
tape('GeoJSON transform consolidates both lon/lat and geojson data', function(test) {
  var data = geodata();
