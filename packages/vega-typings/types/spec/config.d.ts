...
import { ScaledValueRef } from './encode';
import { ColorValueRef, NumericValueRef } from './encode.d';
...
export interface LegendConfig extends ExcludeMappedValueRef<BaseLegend> {
   ...
   */
  symbolBaseFillColor?: Color | SignalRef;
   ...
   */
  symbolBaseStrokeColor?: Color | SignalRef;
