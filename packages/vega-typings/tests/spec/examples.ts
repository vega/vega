...
export const stackedBarChart: Spec = {
  ...
  axes: [{ orient: 'bottom', scale: 'x', zindex: 1 }, { orient: 'left', scale: 'y', zindex: 1 }],
...
export const areaChart: Spec = {
  ...
  axes: [{ orient: 'bottom', scale: 'xscale', tickCount: 20 }, { orient: 'left', scale: 'yscale' }],
...
export const jobVoyager: Spec = {
  ...
  signals: [
    ...
    },
    {
      name: 'query',
      value: '',
      on: [{ events: 'area:click!', update: 'datum.job' }, { events: 'dblclick!', update: "''" }],
      ...
      transform: [
        {
          ...
          groupby: ['job', 'sex'],
          fields: ['perc', 'perc'],
          ops: ['sum' as 'sum', 'argmax' as 'argmax'],
          as: ['sum', 'argmax'],
        },
      ],
    },
  ...
  signals: [
    {
      ...
      bind: {
        input: 'select',
        options: ['IMDB_Rating', 'Rotten_Tomatoes_Rating', 'US_Gross', 'Worldwide_Gross'],
      },
    },
    {
      name: 'xField',
      ...
      transform: [
        {
          ...
          ops: ['mean' as 'mean', 'stdev' as 'stdev', 'stderr' as 'stderr', 'ci0' as 'ci0', 'ci1' as 'ci1', 'q1' as 'q1', 'q3' as 'q3'],
  ...
  scales: [
    {
      ...
      nice: true,
      domain: {
        fields: [{ data: 'counts', field: 'count' }, { data: 'nulls', field: 'count' }],
      },
    },
    {
      name: 'xscale',
...
export const probabilityDensity: Spec = {
      ...
      transform: [
        {
          type: 'aggregate',
          fields: ['u', 'u'],
          ops: ['mean' as 'mean', 'stdev' as 'stdev'],
          as: ['mean', 'stdev'],
        },
      ],
    },
  ...
  scales: [
    ...
    },
    {
      ...
      round: true,
      domain: {
        fields: [{ data: 'density', field: 'density' }, { data: 'normal', field: 'density' }],
      },
    },
    {
      name: 'color',
          ...
          transform: [
            {
              ...
              ops: ['q1' as 'q1', 'median' as 'median', 'q3' as 'q3'],
              as: ['q1', 'median', 'q3'],
            },
          ],
        },
...
export const projections: Spec = {
  ...
  data: [
    ...
    {
      name: 'labelOffsets',
      values: [{ dx: -1, dy: -1 }, { dx: -1, dy: 1 }, { dx: 1, dy: -1 }, { dx: 1, dy: 1 }],
    },
  ],
  ...
  marks: [
    {
      ...
      signals: [{ name: 'width', update: 'mapWidth' }, { name: 'height', update: 'mapHeight' }],
    ...
    },
    {
      ...
      encode: {
        update: {
          ...
          align: { value: 'left' },
          baseline: { value: 'middle' },
          fill: [{ test: 'datum === src', value: 'steelblue' }, { value: 'black' }],
        },
      },
    },
    {
  ...
  signals: [
    {
      name: 'dragging',
      value: false,
      on: [{ events: '@handle:mousedown', update: 'true' }, { events: 'mouseup', update: 'false' }],
    },
    {
      name: 'handleYear',
      value: 2010,
    ...
    },
    {
      ...
      transform: [
        ...
        },
        {
          type: 'aggregate',
          fields: ['value', 'value'],
          ops: ['min' as 'min', 'argmin' as 'argmin'],
          as: ['min', 'argmin'],
        },
        {
          type: 'formula',
  ...
  data: [
    {
      ...
      transform: [
        ...
        },
        {
          ...
          query: [{ signal: 'delayRange' }, { signal: 'timeRange' }, { signal: 'distRange' }],
        },
      ],
    },
  ],
  ...
  marks: [
    {
      ...
      axes: [{ orient: 'bottom', scale: 'xDetail' }, { orient: 'left', scale: 'yDetail' }],
      marks: [
        {
          type: 'group',
          encode: {
