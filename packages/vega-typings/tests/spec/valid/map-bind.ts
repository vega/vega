...
export const spec: Spec = {
  ...
  signals: [
    ...
    { name: 'scale', value: 150, bind: { input: 'range', min: 50, max: 2000, step: 1 } },
    ...
    { name: 'center0', value: 0, bind: { input: 'range', min: -180, max: 180, step: 1 } },
    { name: 'center1', value: 0, bind: { input: 'range', min: -90, max: 90, step: 1 } },
