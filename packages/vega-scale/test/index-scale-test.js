...
tape('Index scale maps ordinal domain to linear range', function(test) {
  ...
  test.deepEqual(scale.invertRange([30, 40]), undefined);
  test.deepEqual(scale.invertRange([-2, -1]), undefined);
  test.deepEqual(scale.invertRange([101, 102]), undefined);
  test.deepEqual(scale.invertRange([0, 0]), domain.slice(0, 1));
  test.deepEqual(scale.invertRange([1, 1]), undefined);
