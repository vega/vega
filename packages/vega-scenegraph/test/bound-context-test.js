...
var boundContext = vega.boundContext;
var EPSILON = 1e-10;
...
test('boundContext should bound arc segments', function() {
  var x = 0,
      y = 0,
      r = 1,
      rh = Math.SQRT1_2,
